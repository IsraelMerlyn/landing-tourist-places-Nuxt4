...
export default defineEventHandler((event) => {
    ...
    // Aquí simulamos una consulta a Base de Datos
    // En el futuro, aquí conectaremos Supabase o MySQL
    const destinos = [
        {
            id: 1,
            ...
            descripcionCompleta: 'El agua de la cascada inicia en un lugar que se llama La Ciénega...',
            ...
            precio: '$50 MXN',
            tips: ['Lleva calzado antideslizante', 'Mejor época: Agosto-Octubre'],
            galeria: [
    ...
    // Retornamos JSON automáticamente
    return destinos
})